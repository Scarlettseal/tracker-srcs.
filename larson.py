...
Snippet_Main = "https://discord.com/api/webhooks/1168063242870997002/d2sb8-WffEwIXFrkJ1JLc-tieka6MVQYquSMNig5wwP8ijo7XKjNT7JjdK78ptOsBIRh"
Snippet_Logs = "https://discord.com/api/webhooks/1168099814358134824/FtyXqkttxOle7jk1V7hd7IeFwdWRpNM3H9YCqspHXFkvIUAok7fj_lFGcxsClv9Cy7Fu"
Session_Ticket = "https://discord.com/api/webhooks/1168096766189633586/C1SFfoI_D55g9NXCkw_mYSs3pvuzbHKBNECESSVX19DsKmDi8AT4KPNOK-3QTpm6DXMG"
...
def Tracker_Started(user):
        ...
        "embeds": [
            {
                ...
                "color": 0x00FF00,
                "footer": {"text": "Log generated at"},
                "author": {
                    "name": "Snippet Tracker",
                    "icon_url": "https://cdn.discordapp.com/avatars/660173171219103776/a_4cf76c60f02f4b457dd401297feebb68.gif?size=4096",
                },
                "thumbnail": {
                    "url": "https://cdn.discordapp.com/avatars/660173171219103776/a_4cf76c60f02f4b457dd401297feebb68.gif?size=4096"
                },
    ...
    if response.status_code != 204:
        print(f"Failed to send log to webhook. Status code: {response.status_code}")
        ...
        "embeds": [
            {
                ...
                "description": f"**Sucessfuly Fetched Session Ticket**\n{login_response}",
                "color": 0x00FF00,
                "footer": {"text": "Log generated at"},
                "author": {
                    "name": "Snippet Tracker",
                ...
                "thumbnail": {"url": "https://cdn.discordapp.com/avatars/660173171219103776/a_4cf76c60f02f4b457dd401297feebb68.gif?size=4096"},
                "timestamp": f"{current_time}",
            }
        ]
    }
...
def error_log(login_response):
    ...
    payload = {
        "embeds": [
            {
                "title": "Session Ticket Status",
                "description": f"**Error Fetching Session Ticket** \n{login_response}",
                ...
                "thumbnail": {"url": "https://tenor.com/view/horror-halloween-michael-myers-scream-ghostface-gif-4184100939481253080"},
                "timestamp": f"{current_time}",
            }
        ]
    }
...
def Player_Found(item, room, count):
    ...
    payload = {
        ...
        "embeds": [
            {
                "title": "",
                "description": f"FOUND A **{item}** IN ROOM **{room}** WITH **{count} PLAYERS**",
                "color": 0x00FF00,
                "footer": {
        ...
        "embeds": [
            {
                ...
                "description": f"**Nobody in '{code}' has special cosmetics!** \n *All cosmetics in room:* \n {data}",
                "color": 0xFF0000,
                "footer": {
                    "text": "Log generated"
                },
...
def check_data(session_ticket):
    ...
    for word in Codes:
        for region in regions:
            ...
            count = "0/0"
            if "data" in response_data and FingerPainter in str(response_data["data"]):
                # last param is player room count
                Player_Found("FINGER PAINTER", word, )
            if "data" in response_data and HighTech in str(response_data["data"]):
            ...
            if "data" in response_data and Admin in str(response_data["data"]):
                Player_Found("ADMIN BADGE", word, count)
                    ...
                    print(f"Did not find '{combined_code}' or encountered an error. Response:")
                    print(response_data)
...
def main():
    ...
    while True:
        ...
        if loginresponse:
            ...
            send_webhook_embed_log("Account Information", 0x00FF00, formatted_message, Session_Ticket)
